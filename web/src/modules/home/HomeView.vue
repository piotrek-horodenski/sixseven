...
import CreateRoomForm from '@/modules/rooms/CreateRoomForm.vue'

// Home = hub (dawne /rooms + /play scalone). Subskrypcję pokoi startujemy tutaj
// (refcount w store obsłuży nakładanie się z RoomDetail, tak jak wcześniej
// robiła to RoomsView).
